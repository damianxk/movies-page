...
import { type SeriesCastMember } from "@/features/series/types/series-credits"
...
type SeriesDetailsCastProps = {
  seriesId: number
  cast: SeriesCastMember[]
}

export function SeriesDetailsCast({ seriesId, cast }: SeriesDetailsCastProps) {
